...
const BadgeItem = ({ activeSrc, src }: { activeSrc: string; src: string }) => {
  ...
  return (
    <div className="flex cursor-pointer items-center ">
      ...
      >
        <RadioGroup.Indicator className="relative flex h-full w-full items-center justify-center after:block after:h-[12px] after:w-[12px] after:rounded-[50%] after:bg-primary after:content-['']" />
      </RadioGroup.Item>
      <label
