...
export type Query = {
  ...
  tpcSoftwareReportMetricClarificationPage?: Maybe<TpcSoftwareReportMetricClarificationPage>;
...
export type TpcSoftwareReportMetricClarification = {
  __typename?: 'TpcSoftwareReportMetricClarification';
...
export type TpcSoftwareReportMetricClarificationPage = {
  __typename?: 'TpcSoftwareReportMetricClarificationPage';
  count?: Maybe<Scalars['Int']>;
  items?: Maybe<Array<TpcSoftwareReportMetricClarification>>;
  page?: Maybe<Scalars['Int']>;
  totalPage?: Maybe<Scalars['Int']>;
};
...
export const CreateTpcSoftwareReportMetricClarificationDocument = /*#__PURE__*/ `
    mutation createTpcSoftwareReportMetricClarification($shortCode: String!, $metricName: String!, $content: String!) {
  createTpcSoftwareReportMetricClarification(
...
export const TpcSoftwareReportMetricClarificationPageDocument = /*#__PURE__*/ `
    query tpcSoftwareReportMetricClarificationPage($shortCode: String!, $metricName: String!, $page: Int, $per: Int) {
  tpcSoftwareReportMetricClarificationPage(
    shortCode: $shortCode
    page: $page
    per: $per
