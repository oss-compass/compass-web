...
export type Mutation = {
  ...
  /** Create a tpc software selection comment */
  ...
  /** Delete a tpc software selection comment */
  ...
  /** Update a tpc software selection comment */
...
export const CreateTpcSoftwareSelectionCommentDocument = /*#__PURE__*/ `
    mutation createTpcSoftwareSelectionComment($selectionId: Int!, $content: String!) {
  createTpcSoftwareSelectionComment(
    input: {selectionId: $selectionId, content: $content}
  ) {
    errors {
      message
      path
...
export const TpcSoftwareSelectionCommentPageDocument = /*#__PURE__*/ `
    query tpcSoftwareSelectionCommentPage($selectionId: Int!, $page: Int!, $per: Int!) {
  tpcSoftwareSelectionCommentPage(
    page: $page
    per: $per
