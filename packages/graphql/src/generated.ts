...
export type CodeRepo = {
  ...
  repoTechnologyType?: Maybe<Scalars['String']>;
};
...
export type CommitTechType = {
  __typename?: 'CommitTechType';
  linesAdded?: Maybe<Scalars['Int']>;
  linesChanged?: Maybe<Scalars['Int']>;
  linesRemoved?: Maybe<Scalars['Int']>;
  repoTechnologyType?: Maybe<Scalars['String']>;
...
export type CommitTechTypePage = {
  __typename?: 'CommitTechTypePage';
  count?: Maybe<Scalars['Int']>;
  items?: Maybe<Array<CommitTechType>>;
  page?: Maybe<Scalars['Int']>;
  totalPage?: Maybe<Scalars['Int']>;
};
...
export type Query = {
  ...
  commitsTechTypePage: CommitTechTypePage;
...
export type QueryCommitsTechTypePageArgs = {
  beginDate?: InputMaybe<Scalars['ISO8601DateTime']>;
  branch?: InputMaybe<Scalars['String']>;
  endDate?: InputMaybe<Scalars['ISO8601DateTime']>;
  filterOpts?: InputMaybe<Array<FilterOptionInput>>;
...
export type RepoExtensionInput = {
  ...
  /** Repository name */
  repoName: Scalars['String'];
  /** Technical field of the Repository */
  repoTechnologyType: Scalars['String'];
};
...
export type CommitsRepoDataListQuery = {
  ...
  commitsRepoPage: {
    ...
    items?: Array<{
      ...
      repoTechnologyType?: string | null;
    }> | null;
  };
};
...
export type CommitsTechTypePageQueryVariables = Exact<{
  label: Scalars['String'];
  level?: InputMaybe<Scalars['String']>;
  branch?: InputMaybe<Scalars['String']>;
  page?: InputMaybe<Scalars['Int']>;
...
export type CommitsTechTypePageQuery = {
  __typename?: 'Query';
  commitsTechTypePage: {
    __typename?: 'CommitTechTypePage';
    count?: number | null;
...
export const CommitsTechTypePageDocument = /*#__PURE__*/ `
    query commitsTechTypePage($label: String!, $level: String = "repo", $branch: String = "master", $page: Int, $per: Int, $filterOpts: [FilterOptionInput!], $sortOpts: [SortOptionInput!], $beginDate: ISO8601DateTime, $endDate: ISO8601DateTime) {
  commitsTechTypePage(
    label: $label
    level: $level
    branch: $branch
    ...
    `;
export const useCommitsTechTypePageQuery = <
  TData = CommitsTechTypePageQuery,
  TError = unknown
>(
  client: GraphQLClient,
  variables: CommitsTechTypePageQueryVariables,
  options?: UseQueryOptions<CommitsTechTypePageQuery, TError, TData>,
  headers?: RequestInit['headers']
) =>
  useQuery<CommitsTechTypePageQuery, TError, TData>(
    ['commitsTechTypePage', variables],
    fetcher<CommitsTechTypePageQuery, CommitsTechTypePageQueryVariables>(
      client,
      CommitsTechTypePageDocument,
      variables,
      headers
    ),
    options
...
useCommitsTechTypePageQuery.getKey = (
  variables: CommitsTechTypePageQueryVariables
) => ['commitsTechTypePage', variables];
useCommitsTechTypePageQuery.fetcher = (
  client: GraphQLClient,
  variables: CommitsTechTypePageQueryVariables,
  headers?: RequestInit['headers']
) =>
