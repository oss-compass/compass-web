...
export type ModelDetail = {
  ...
  isGeneral: Scalars['Boolean'];
  isPublic: Scalars['Boolean'];
  /** Details of the 3 latest updates */
...
export type UserModelsQueryVariables = Exact<{
  page: Scalars['Int'];
  per: Scalars['Int'];
}>;

export type UserModelsQuery = {
  __typename?: 'Query';
  myModels?: {
    __typename?: 'MyModels';
    count?: number | null;
...
export const MetricStatFragmentDoc = /*#__PURE__*/ `
  ...
  median
    ...
    `;
export const UserModelsDocument = /*#__PURE__*/ `
...
${DatasetFragmentDoc}
${MetricsFragmentDoc}`;
export const useUserModelsQuery = <TData = UserModelsQuery, TError = unknown>(
  client: GraphQLClient,
  variables: UserModelsQueryVariables,
  options?: UseQueryOptions<UserModelsQuery, TError, TData>,
  headers?: RequestInit['headers']
) =>
  useQuery<UserModelsQuery, TError, TData>(
    ['userModels', variables],
    fetcher<UserModelsQuery, UserModelsQueryVariables>(
      client,
      UserModelsDocument,
      variables,
      headers
...
useUserModelsQuery.getKey = (variables: UserModelsQueryVariables) => [
  'userModels',
  variables,
];
useUserModelsQuery.fetcher = (
  client: GraphQLClient,
  variables: UserModelsQueryVariables,
  headers?: RequestInit['headers']
) =>
