...
export type TpcSoftwareReportMetricClarificationState = {
  ...
  complianceDco?: Maybe<Array<TpcSoftwareReportMetricClarificationStateDetail>>;
  complianceLicense?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  complianceLicenseCompatibility?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  compliancePackageSig?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  ecologyAdoptionAnalysis?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  ecologyCodeMaintenance?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  ecologyCommunitySupport?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  ecologyDependencyAcquisition?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  ecologyPatentRisk?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  ecologySoftwareQuality?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  lifecycleVersionLifecycle?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  lifecycleVersionNormalization?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  lifecycleVersionNumber?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  securityBinaryArtifact?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  securityHistoryVulnerability?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  securityVulnerability?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  securityVulnerabilityDisclosure?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
  securityVulnerabilityResponse?: Maybe<
    Array<TpcSoftwareReportMetricClarificationStateDetail>
  >;
};

export type TpcSoftwareReportMetricClarificationStateDetail = {
  __typename?: 'TpcSoftwareReportMetricClarificationStateDetail';
  createdAt: Scalars['ISO8601DateTime'];
  id: Scalars['Int'];
  /** committer: 0, sig lead: 1 */
...
export const TpcClarificationStateDetailFragmentDoc = /*#__PURE__*/ `
    fragment tpcClarificationStateDetail on TpcSoftwareReportMetricClarificationStateDetail {
  createdAt
  id
  memberType
  metricName
...
export const AcceptTpcSoftwareReportMetricClarificationDocument = /*#__PURE__*/ `
    mutation acceptTpcSoftwareReportMetricClarification($shortCode: String!, $metricName: String!, $state: Int!, $memberType: Int!) {
  acceptTpcSoftwareReportMetricClarification(
    input: {shortCode: $shortCode, metricName: $metricName, state: $state, memberType: $memberType}
  ) {
    errors {
      message
      path
