...
const TotalScore = () => {
  ...
  const tansOpts: TransOpt = {
    ...
    yKey: 'metricDomainPersona.domainPersonaScore',
    summaryKey: '',
  };
  const {
    getOptions,
  ...
  return (
    <BaseCard
      title={t('metrics_models:contributor_domain_persona.title')}
      id={ContributorDomainPersona.Overview}
      description={t('metrics_models:contributor_domain_persona.desc')}
