        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-3 gap-6 lg:grid-cols-3">
            <Card
              title={
                i18n.language === 'en'
                  ? `Role Score (2024: ${eco.roleScore2024.toFixed(
                      2
                    )} → 2025: ${eco.roleScore2025.toFixed(2)})`
                  : `角色得分（2024：${eco.roleScore2024.toFixed(
                      2
                    )} → 2025：${eco.roleScore2025.toFixed(2)}）`
              }
              size="small"
            ...
            <Card
              title={
                i18n.language === 'en'
                  ? `Code Issue Contribution Score (2024: ${eco.contributionScore2024.toFixed(
                      2
                    )} → 2025: ${eco.contributionScore2025.toFixed(2)})`
                  : `代码Issue贡献得分（2024：${eco.contributionScore2024.toFixed(
                      2
                    )} → 2025：${eco.contributionScore2025.toFixed(2)}）`
              }
              size="small"
            ...
            <Card
              title={
                i18n.language === 'en'
                  ? `Collaboration Influence Score (2024: ${eco.influenceScore2024.toFixed(
                      2
                    )} → 2025: ${eco.influenceScore2025.toFixed(2)})`
                  : `协作影响力得分（2024：${eco.influenceScore2024.toFixed(
                      2
                    )} → 2025：${eco.influenceScore2025.toFixed(2)}）`
              }
              size="small"
