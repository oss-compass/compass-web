...
export const USER_JOURNEY_PAIN_GUIDE_ITEMS_INFO: PainGuideItem[] = [
  ...
  },
  {
    ...
    english: 'Critical',
    description:
      '在S1_SETUP（环境检查与准备）和S3_DEVELOPMENT（开发与编译）中的环境配置、编译、构建等任务中出现报错或者中断，开发者自行尝试并已解决。',
    rowClassName: 'bg-red-50',
    cardClassName: 'border-rose-200 bg-white',
    iconType: 'exclamation',
    accentColor: '#f43f5e',
  },
  {
    ...
    english: 'Major',
    description:
      '在S0_DISCOVERY（搜索与发现）和S2_QUICKSTART（样例快速验证）任务中出现报错或者中断，开发者自行尝试并已解决。',
    rowClassName: 'bg-amber-50',
    cardClassName: 'border-amber-200 bg-white',
    iconType: 'exclamation',
    accentColor: '#d97706',
  },
  {
    ...
    english: 'Minor',
    description:
      '在S4_TESTING（测试与验证） 任务中出现报错或者中断，开发者自行尝试并已解决。',
    rowClassName: 'bg-emerald-50',
    cardClassName: 'border-emerald-200 bg-white',
    iconType: 'check',
    accentColor: '#059669',
