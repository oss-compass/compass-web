...
export const PROJECTS_CONFIG: ProjectConfig[] = [
  ...
  {
    slug: 'CUDA_ai_framework_adapter',
    name: 'CUDA 生态-AI框架适配',
    displayName: 'CUDA 生态-AI框架适配',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_ai_framework_adapter',
  },
  {
    slug: 'CUDA_ai_framework',
    name: 'CUDA 生态-AI框架',
    displayName: 'CUDA 生态-AI框架',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_ai_framework',
  },
  {
    slug: 'CUDA_communication_library',
    name: 'CUDA 生态-通信库',
    displayName: 'CUDA 生态-通信库',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_communication_library',
  },
  {
    slug: 'CUDA_compiler',
    name: 'CUDA 生态-编译器',
    displayName: 'CUDA 生态-编译器',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_compiler',
  },
  {
    slug: 'CUDA_domain_acceleration_library',
    name: 'CUDA 生态-领域加速库',
    displayName: 'CUDA 生态-领域加速库',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_domain_acceleration_library',
  },
  {
    slug: 'CUDA_driver',
    name: 'CUDA 生态-驱动',
    displayName: 'CUDA 生态-驱动',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_driver',
  },
  {
    slug: 'CUDA_graph_engine',
    name: 'CUDA 生态-图引擎',
    displayName: 'CUDA 生态-图引擎',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_graph_engine',
  },
  {
  ...
  {
    slug: 'CUDA_programming_language',
    name: 'CUDA 生态-编程语言',
    displayName: 'CUDA 生态-编程语言',
    developers: 48371,
    organizations: 16137,
    folderName: 'CUDA_programming_language',
  },
  {
    slug: 'CUDA_runtime',
    name: 'CUDA 生态-运行时',
    displayName: 'CUDA 生态-运行时',
    developers: 48371,
    organizations: 16137,
