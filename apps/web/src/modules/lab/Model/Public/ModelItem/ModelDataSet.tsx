...
const ModelDataSet: React.FC<{
  ...
  return (
    <>
          ...
          return (
            <div
              ...
              className={classnames(
                'line-clamp-1 mr-2 flex h-5 cursor-pointer rounded-full border bg-[#F1F1F1] px-2.5 text-xs text-[#585858]',
      ...
      <div className=">2xl:grid-cols-5 flex w-full flex-wrap content-evenly gap-3 pb-12 pt-2 sm:grid-cols-1 md:grid-cols-2 md:gap-4 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
        {repoList.map((i) => {
          return (
            <RepoCard
              repo={i}
