...
const metrics: OsBoardMetric[] = [
  ...
  { id: 'commits', name: '代码提交', category: '社区活跃度', unit: '次' },
  {
    id: 'issues_opened',
    name: 'Issue 创建',
    category: '社区活跃度',
  ...
  { id: 'prs_opened', name: 'PR 提交', category: '社区活跃度', unit: '个' },
  { id: 'prs_merged', name: 'PR 合并', category: '社区活跃度', unit: '个' },
  {
  ...
  { id: 'contributors', name: '贡献者总数', category: '贡献统计', unit: '人' },
  {
    id: 'new_contributors',
    name: '新增贡献者',
    category: '贡献统计',
