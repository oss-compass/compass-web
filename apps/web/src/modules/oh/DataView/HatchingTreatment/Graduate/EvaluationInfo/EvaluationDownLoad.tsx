...
import { useTpcSoftwareGraduationReportRowQuery } from '@oss-compass/graphql';
import client from '@common/gqlClient';
import { Popover, Dropdown } from 'antd';
import type { MenuProps } from 'antd';
import { DownloadOutlined, LoadingOutlined } from '@ant-design/icons';
import { downloadReport } from '@modules/oh/DataView/HatchingTreatment/Graduate/EvaluationInfo/MerticDetail';

const DownloadReportRow = ({ item, setLoadingDownLoad }) => {
  useTpcSoftwareGraduationReportRowQuery(
    client,
    { shortCode: item.shortCode },
    {
      onSuccess: (data) => {
        item.tpcSoftwareReportMetricRaw =
          data?.tpcSoftwareGraduationReport?.graduationReportMetricRaw;
        downloadReport(item);
