...
import { getMetricItemScore } from '@modules/oh/utils';

const EvaluationScore = ({ items, score }) => {
  // const items = [
  //   {
  //     name: '合法合规',
  //     score: 73,
...
const EvaluationDetail = ({ back, item }: { item: any; back?: () => void }) => {
  ...
  //   let score = itemScore[index] as number;
  //   return { ...item, score };
  // });
  return (
    <div>
      ...
      <EvaluationScore items={item.evaluationDetail} score={item.score} />
      <div className="mt-6">
