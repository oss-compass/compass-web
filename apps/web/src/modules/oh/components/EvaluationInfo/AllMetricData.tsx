export const allMetricData = [
  {
    ...
    风险重要性: '高',
    指标检查项及评分项:
      '设置评分。仓库标准位置包含许可证且许可证在准入清单内 10 分；仓库非标准位置包含许可证且许可证在准入清单内 8 分；许可证不在准入清单 6 分；无许可证 0 分；',
  ...
  // },
  {
    ...
    风险重要性: '高',
    指标检查项及评分项:
      '不设置评分，仅检查是否满足。引入软件项目级、文件级许可证不允许存在兼容性问题',
    指标意义:
  ...
  },
  {
    ...
    风险重要性: '高',
    指标检查项及评分项:
      '设置评分。引入软件依赖的库必须是开源软件，可公开获得。在上述基础上保留原开源软件的提交记录 10 分，无记录 6 分',
    指标意义:
