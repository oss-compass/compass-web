import { useGetRisk } from '@modules/oh/DataView/HatchingTreatment/Sandbox/EvaluationInfo/store/useRiskStore';
import { useMemo } from 'react';

const useCheckSandboxRiskState = (shortCode, mertic) => {
...
export default useCheckSandboxRiskState;
